...
<div class="container my-5 p-5 border" style="max-width: 800px;">
    ...
    <form method="POST" action="" class="row g-3 needs-validation">
        ...
        <div class="row d-flex justify-content-center mt-4">
            ...
            <div class="col-auto">
                <a href="../controler/liste-patients-controler.php" class="btn btn-outline-secondary btn-sm p-2" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-person" viewBox="0 0 16 16">
